...
> = (this: ThisType<Target[FnKey]>, invoke: Target[FnKey], ...args: Parameters<FunctionOfTarget<Target, FnKey>>) => ReturnType<FunctionOfTarget<Target, FnKey>>;
...
> {
  ...
  private _fnSwapper: PropertySwapper<Target, FnKey, FunctionOfTarget<Target, FnKey>>;
  ...
  private runMiddlewares(args: Parameters<FunctionOfTarget<Target, FnKey>>): ReturnType<(typeof this._middlewares)[number]> {
